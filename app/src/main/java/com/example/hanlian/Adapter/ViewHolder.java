...
//    private static LoadImage mImageLoader  = new LoadImage();
    ...
    public ViewHolder(Context context, ViewGroup parent, int resLayoutId,
                      int position) {
        this.mPosition = position;
        mViews = new SparseArray<View>();
        mConvertView = LayoutInflater.from(context).inflate(resLayoutId, parent,
                false);
    ...
    public static ViewHolder getViewHolder(Context context, ViewGroup parent,
                                           View convertView, int resLayoutId, int position) {
        if (convertView == null) {
    ...
    * */
     ...
     * @return
     */
	public ViewHolder setImageForURL(Context context ,int viewID, String url, int resID) {
