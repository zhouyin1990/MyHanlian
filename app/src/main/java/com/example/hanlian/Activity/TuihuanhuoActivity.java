...
public class TuihuanhuoActivity extends Activity  implements OnClickListener{
	...
	private void intidata() {
				...
				parms.put("account", "333333");
				parms.put("password","123456");
				
				HTTPUtils.get(TuihuanhuoActivity.this, TCHConstants.url.GETTESTTOKEN, parms, new ResponseListener() {
					...
					public void onResponse(String arg0) {
						...
						if(errorCode==0)
						{
							  ...
							  paramsshouhou.put("token", TestTkoen); 
