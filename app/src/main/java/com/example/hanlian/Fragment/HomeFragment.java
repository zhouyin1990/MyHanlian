...
import com.example.hanlian.DateModel.HomeBannerJson;
...
public class HomeFragment extends Fragment implements OnPageChangeListener, ScrollViewListener, OnClickListener {
    ...
    private String[] str = new String[]{}; //初始化  length == 0
...
//	ArrayList<JSONArray> homeshowlists = new ArrayList<JSONArray>();
    ...
    private JSONArray jsonArraybanner = new JSONArray();
    ...
    private void intibannerdata() {

        HTTPUtils.get(getContext(), TCHConstants.url.Banner, new ResponseListener() {
            ...
            @Override
            public void onResponse(String ago) {


//				HomeBannerJson homeBannerJson = GsonUtils.parseJSON(ago, HomeBannerJson.class);
//				String img_url = homeBannerJson.getImg_url();
                try {
                    jsonArraybanner = new JSONArray(ago);
                    ...
                    myview.setRealNum(jsonArraybanner.length());

//					Log.e("jsonArraybanner==",jsonArraybanner.length()+"" );
...
//	}
    ...
    class BannerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (jsonArraybanner.length() != 0) {
                position %= jsonArraybanner.length();
                BannerItemFragment ItemFragment = new BannerItemFragment(position);
                Bundle bundle = new Bundle();
                try {
                    String url = jsonArraybanner.getJSONObject(position).getString("img_url");
