...
public class Result {
    ...
    @SerializedName("CM_LOGISTICSNUM")
    @Expose
    private Object CMLOGISTICSNUM;
     ...
     *     The CMLOGISTICSNUM
     */
    public Object getCMLOGISTICSNUM() {
        return CMLOGISTICSNUM;
    }

    /**
     * 
     * @param CMLOGISTICSNUM
     *     The CM_LOGISTICSNUM
     */
    public void setCMLOGISTICSNUM(Object CMLOGISTICSNUM) {
        this.CMLOGISTICSNUM = CMLOGISTICSNUM;
    }
