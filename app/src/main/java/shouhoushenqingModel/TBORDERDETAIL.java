...
public class TBORDERDETAIL {
    ...
    @SerializedName("CM_ORDERDETAILSID")
    @Expose
    ...
    @SerializedName("CM_SERVICE_STATE")
    @Expose
    ...
    /**
     * 
     * @param CMORDERDETAILSID
     *  The CM_ORDERDETAILSID
     */
    public void setCMORDERDETAILSID(String CMORDERDETAILSID) {
        this.CMORDERDETAILSID = CMORDERDETAILSID;
    }
    ...
    /**
     * 
     * @param CMSERVICESTATE
     *     The CM_SERVICE_STATE
     */
